...
void BluetoothHandler::writeToBLE(String packet){
...
void BluetoothHandler::setCallback(std::function<void(char*)> callback) {
...
//  * @return false
//  */
bool BluetoothHandler::connectToServer()
{
  ...
  if (pRChr->canNotify()){
    // pRChr->subscribe(true, BluetoothEvent);
    pRChr->subscribe(true, std::bind(&BluetoothHandler::BluetoothEvent, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
  }
  connected = true;
  return true;
}
...
void BluetoothHandler::BluetoothEvent(BLERemoteCharacteristic *pBLERemoteCharacteristic, uint8_t *pData, size_t length, bool isNotify)
{
 ...
 */
bool BluetoothHandler::isJsonComplete(const char *data, size_t length)
{
 ...
 */
void BluetoothHandler::removeWhitespace(char *str)
{
 ...
 */
void BluetoothHandler::handleJson(char *jsonstr)
{
