...
void OledDisplay::testfillcircle(void) {
  display.clearDisplay();
...
void OledDisplay::testdrawstyles(void) {
  display.clearDisplay();
...
void OledDisplay::testdrawbitmap(void) {
  display.clearDisplay();
...
void OledDisplay::testanimate(const uint8_t *bitmap, uint8_t w, uint8_t h) {
